...
//        Debug::dump(htmlentities($this->html));
//        $t = new TextTemplate($this->html);
//        $a = $t->apply($this->getBinds());
//        Debug::dump(htmlentities($a));
//        return $a;
//    }
//
//    public function layout($name, $callback) {
//        $contents = $this->getFile($name);
//        $contents = $this->replace(__FUNCTION__, $callback(), $contents);
//        $this->html = $contents;
//    }
//
...
//    }
//
//    public function block($name, $binds = array()) {
//        $contents = $this->getFile($name);
//        foreach ($binds as $search => $replace) {
//            $contents = $this->replace($search, $replace, $contents);
//        }
//        return $contents;
//    }
//
//    public function foreachBlock($block, $bind) {
//        $results = '';
//        foreach ($this->getBind($bind) as $data):
//            $results .= $this->block($block, $data);
//        endforeach;
//        return $results;
//    }
//
...
//        Debug::dump($subject);
//        $a = str_replace('*', $search, $this->variable);
//        Debug::dump($a);
//        $b = str_replace($a, $replace, $subject);
//        return $b;
//    }
//
//    private function replaceBinds($contents) {
//        foreach ($this->getBinds() as $search => $replace) {
